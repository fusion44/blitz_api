...
import app.repositories.ln_impl.protos.rpc_pb2 as rpc__pb2
...
ResolveHoldForwardAction = enum_type_wrapper.EnumTypeWrapper(
    _RESOLVEHOLDFORWARDACTION)
...
_FORWARDHTLCINTERCEPTREQUEST.fields_by_name[
    'custom_records'].message_type = _FORWARDHTLCINTERCEPTREQUEST_CUSTOMRECORDSENTRY
